...
ChatLogic::~ChatLogic()
{
    ...
    // Task5: delete is not longer necessary
    // delete _chatBot;

    // Task3: make GraphNodes unique_ptr
    // delete all nodes
    ...
    // Task4: move GraphEdges from ChatLogic to parent GraphNodes
    // delete all edges
